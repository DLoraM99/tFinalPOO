...
public class DoctorJF extends javax.swing.JFrame {
    ...
    private void cerrar(){
        try {
            this.setDefaultCloseOperation(DoctorJF.DO_NOTHING_ON_CLOSE);
    ...
    private void initComponents() {
        ...
        jMenuItem4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/acercade.png"))); // NOI18N
        ...
        jMenuItem3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/cerrarSesion.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DoctorJF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
