...
public class AdministrativoJF extends javax.swing.JFrame {
    ...
    private void cerrar(){
        try {
            this.setDefaultCloseOperation(EnfermeroJF.DO_NOTHING_ON_CLOSE);
    ...
    public void confirmarSalida(){
        int valor= JOptionPane.showConfirmDialog(this,"¿Desea cerrar sesión?","Advertencia",JOptionPane.YES_NO_OPTION);
    ...
    private void initComponents() {
        ...
        ImageIcon icon = new ImageIcon(this.getClass().getResource("/imagenes/admin.png"));
        ...
        jButton1.setText("Ver Todos los Pacientes");
        ...
        jMenuItem3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/ver.png"))); // NOI18N
        jMenuItem3.setText("Todos los pacientes");
